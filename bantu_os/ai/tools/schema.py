...
BUILTIN_TOOLS: List[Tool] = [
    ...
    Tool(
        ...
        params=[
            ...
            ToolParam(
                name="time_range",
                description="Time range: 'day', 'week', 'month', 'year', or 'anytime'.",
                type="string",
                required=False,
                default="anytime",
            ),
    ...
    Tool(
        ...
        params=[
            ToolParam(
                name="recipient",
                description="Recipient identifier (username, email, or channel).",
                type="string",
            ),
            ToolParam(
                name="body", description="The message content to send.", type="string"
            ),
        ],
    ),
]
