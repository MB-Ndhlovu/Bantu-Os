...
class FileService:
    ...
    def read(self, path: str, max_bytes: int = 1_000_000, encoding: str = 'utf-8') -> str:
    ...
    def copy(self, src: str, dst: str, *, allow_overwrite: bool = False) -> Dict[str, Any]:
    ...
    def move(self, src: str, dst: str, *, allow_overwrite: bool = False) -> Dict[str, Any]:
